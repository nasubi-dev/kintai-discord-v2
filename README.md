...
- **`/start`** - 勤務開始
  - `time` (オプション): 開始時刻を指定 (例: `09:00`, `0900`)
  - `day` (オプション): 開始日を指定 (例: `2023-03-15`, `today`, `yesterday`, `-1`)
- **`/end`** - 勤務終了
  - `todo` (必須): やったことを記録 (例: `コーディング`, `会議`, `資料作成`)
  - `time` (オプション): 終了時刻を指定
...
- `2023-03-15` (YYYY-MM-DD 形式)
- `20230315` (YYYYMMDD 形式)
- `today` (今日)
- `yesterday` (昨日)
- `-1` (昨日), `0` (今日), `1` (明日) など相対日付
...
- それでもうまく行かない場合､`/reset`をDiscord上で実行し､もう一度初回セットアップを行ってください｡



### サポート

- 技術的な問題: GitHub Issues または [専用Discordサーバー](https://discord.gg/h8Eg7mJwCQ)で報告してください
