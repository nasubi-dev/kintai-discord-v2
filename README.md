...
- `/setup` や `/reset` は Discord サーバーの管理者のみ実行可能です
- サーバー設定で管理者権限を確認してください

#### 3. 「サーバー設定が見つかりません」

- 最初に管理者が `/setup` コマンドで初期設定を行ってください
...
その後、`/setup` で再設定を行ってください。

### サポート

- 詳細な設定手順: [docs/クイックスタートガイド.md](docs/クイックスタートガイド.md)
...
このプロジェクトの開発に参加したい方は、以下のドキュメントをご参照ください：

- **[開発者向けガイド](docs/開発者向けガイド.md)** - 開発環境のセットアップからデプロイまで
- **[プロジェクト構成](docs/開発者向けガイド.md#プロジェクト構成の理解)** - ソースコードの構造と役割
- **[コントリビューション](docs/開発者向けガイド.md#コントリビューション)** - Pull Request の作成方法
